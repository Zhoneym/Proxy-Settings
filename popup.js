const locales = {
  en: {
    ...
    mode_system: "🖥️ Use system proxy settings",
  ...
  de: {
    ...
    mode_system: "🖥️ Systemeinstellungen für Proxy verwenden",
    proxy_host_label: "🖥️ Proxy-Host",
  ...
  fr: {
    ...
    mode_system: "🖥️ Utiliser les paramètres proxy du système",
  ...
  ar: {
    ...
    mode_system: "🖥️ استخدام إعدادات البروكسي الخاصة بالنظام",
